...
export default function Home({ data }) {
    ...
    const countBoxes = [
        ...
        { label: 'Available Licenses', value: data?.available_licenses, icon: <VpnKeyIcon color="info" /> },
        { label: 'Sold Licenses', value: data?.active_licenses, icon: <VpnKeyIcon color="info" /> },
    ];
